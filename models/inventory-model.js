...
/* ***************************
 *  Get details items by veichle_id
 * ************************** */
async function getDetailByVeichleId (inv_id) {
  try {
    const data = await pool.query(
...
module.exports = { getClassifications, getInventoryByClassificationId, getDetailByVeichleId, updateInventory, deleteInventoryItem };